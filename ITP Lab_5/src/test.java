...
public class test{
    ...
    public static void main(String[] args) {
        ...
        find_number("bgfgfgg7.9fr88deded9.098ded10ed54");
        find_number("53.98 53,98 668 123,2 098 100");
    ...
    public static void password_checker(String input_text){
        ...
        try{
            ...
            //проверка на наличие хотя бы 1 заглавную букву
            ...
            //проверка на наличие хотя бы 1 цифру
    ...
    public static void ip_checker(String input_string){
        ...
        try{
            ...
            //все варианты + точка и продолжение, либо точка и окончание строки. и так 4 раза
